...
import com.mughitszufar.notes2.ui.list.ListFragment
import com.mughitszufar.notes2.ui.list.ListFragmentDirections
...
class BindingAdapter {
    ...
    companion object {
        ...
        @JvmStatic
        fun parseProriorityToInt(view: Spinner,priority: Priority){
            when(priority){
